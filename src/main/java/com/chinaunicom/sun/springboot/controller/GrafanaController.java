...
public class GrafanaController {
    private Logger logger = Logger.getLogger(GrafanaController.class);
...
ConfigBean configBean;
    ...
    public String login(){
        ...
        HttpGetInfo httpGetInfo =httpGetByType("http://10.125.128.12:3000/api/login/ping", "", header);
...
/*            for (Map.Entry<String, String> entry : header.entrySet()) {
            ...
            get.setHeader("Authorization", "Bearer eyJrIjoiTWR1ckNZMVRYMjNGdjFBeTJOcG1QWVNnMkZTQkJmZTQiLCJuIjoicWluZ2hhaSIsImlkIjoxfQ==");
